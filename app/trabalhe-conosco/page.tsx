...
const plans = [
  {
    ...
    items: [
      ...
      "4 horas fixas por semana: R$ 760 por mês",
      "8 horas fixas por semana: R$ 1.440 por mês",
      "Hora adicional em qualquer pacote: R$ 50",
    ],
    note: "No pacote mensal de 8 horas semanais, cada diária equivale a aproximadamente R$ 332 pela média anual. A profissional cuida da própria agenda, clientela e materiais.",
  },
  {
