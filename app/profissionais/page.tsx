...
const professionals: Professional[] = [
  ...
  },
  {
    id: "luana-finco",
    name: "Luana Finco",
    role: "Massoterapeuta & Terapeuta Integrativa",
    subtitle: "Head Spa, terapias integrativas e experiências de bem-estar",
    image: "/image/profissionais/Luana-Finco.jpeg",
    imagePosition: "center 28%",
    alt: "Luana Finco, massoterapeuta e terapeuta integrativa da Unaessential",
    summary: "Um cuidado que integra corpo, mente e couro cabeludo.",
    experience: "Cuidados capilares desde 2016, técnicas integrativas desde 2020 e massoterapia desde 2021.",
    about: [
      "Entre 2016 e 2019, Luana conduziu seu próprio salão, onde realizava tratamentos e cuidados capilares com linhas profissionais. Nesse período, também desenvolveu conhecimentos básicos de colorimetria e aplicação de coloração, fortalecendo seu olhar para beleza, autoestima e cuidado individual.",
      "Atualmente, atua com massoterapia, terapias integrativas, massagem crânio-facial, Head Spa e técnicas de cuidados corporais e capilares. Seu trabalho une conhecimento técnico e percepção individual para reconhecer diferentes níveis de sensibilidade do corpo e do couro cabeludo.",
      "Mais do que uma massagem ou um cuidado capilar, Luana oferece uma experiência de pausa, presença e reconexão: um atendimento personalizado, acolhedor e profundamente relaxante que integra corpo, mente e couro cabeludo.",
    ],
    journey: [
      { title: "O cuidado capilar como ponto de partida", text: "De 2016 a 2019, Luana esteve à frente de seu próprio salão, aplicando tratamentos e cuidados capilares com linhas profissionais e acompanhando de perto as necessidades de cada cliente." },
      { title: "Das técnicas integrativas à massoterapia", text: "Em 2020, passou a trabalhar com técnicas integrativas e a desenvolver uma abordagem orientada pela escuta, pelo equilíbrio e pela visão holística. Em 2021, aprofundou sua atuação em massoterapia, reunindo diferentes técnicas manuais para aliviar tensões e promover bem-estar." },
      { title: "Cuidado completo na Unaessential", text: "Hoje, integra a experiência com cabelos, massagens, terapias integrativas e experiências de SPA em protocolos personalizados, olhando para cada pessoa como um todo." },
    ],
    education: [
      ...
      { title: "Colorimetria e aplicação de coloração", type: "Conhecimentos básicos" },
    ],
    services: [
