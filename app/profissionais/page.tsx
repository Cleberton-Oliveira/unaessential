...
const professionals: Professional[] = [
  ...
  },
  {
    ...
    about: [
      "Entre 2016 e 2019, Luana conduziu seu próprio salão, onde trabalhava com tratamentos e cuidados capilares utilizando linhas profissionais. Essa experiência fortaleceu seu olhar para o cuidado individual e para a relação entre beleza, autoestima e bem-estar.",
      "A partir de 2020, aprofundou-se nas técnicas integrativas e, em 2021, passou a atuar também com massoterapia. Hoje, combina massagens, terapias holísticas e experiências como Head Spa, Day Spa, plástica dos pés e SPA dos pés.",
      "Sua abordagem considera cada pessoa de forma ampla, respeitando as necessidades do corpo, da mente e do momento vivido para promover saúde, leveza, equilíbrio e bem-estar.",
    ],
    journey: [
